...
class ProfileDetailsPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Mon Profil - Administrateur")
    ...
    def load_profile(self):
        try:
            response = requests.get("http://localhost:8090/api/admins/email", params={"email": Session.current_user_email})
            ...
            self.labels["Nom"].setText(f"Erreur de connexion : {str(e)}")
